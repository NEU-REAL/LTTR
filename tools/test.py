...
from lttr.config import cfg, cfg_from_list, cfg_from_yaml_file, log_config_to_file
from lttr.datasets import build_dataloader
from lttr.models import build_network
...
def parse_config():
    ...
    parser.add_argument('--start_epoch', type=int, default=40, help='')
